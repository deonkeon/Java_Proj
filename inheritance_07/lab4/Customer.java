...
public class Customer {		// 고객 정보를 나타내는 부모 클래스
	...
	protected String customerGrade;	// 고객 등급 (VIP, Gold, Silver....) 적립포인트, 할인률
	int bonusPoint;					// 보너스 포인트, 포인트 적립 : 고객 등급에 따라서 차등 적립
	double bonusRatio;				// 포인트 적립 비율 : 고객 등급에 따라서 물품값을 할인
	
	public Customer() {				// 기본 생성자 : 기본 회원 등급 초기화
	...
	/* customerID, customerName, customerGrade 의 get & setter */
